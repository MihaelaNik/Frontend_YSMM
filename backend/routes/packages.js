...
// reports / money
router.post("/post-totalMoney", controller.totalMoney);
router.post("/singlePackageMoney", controller.singlePackageMoney);

router.post("/post-listSentPackages", controller.listSentPackages);
router.post("/post-listReceiverPackages", controller.listReceiverPackages);
