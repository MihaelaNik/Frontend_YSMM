  ...
  useEffect(() => {
    const load = async () => {
      ...
      try {
        ...
        if (!resClient.ok) {
          throw new Error(dataClient.error || "Грешка при зареждане на профила.");
        }
        ...
        if (!resSent.ok) {
          throw new Error(dataSent.error || "Грешка при зареждане на изпратени пратки.");
        }
        ...
        if (!resRec.ok) {
          throw new Error(dataRec.error || "Грешка при зареждане на получени пратки.");
        }
