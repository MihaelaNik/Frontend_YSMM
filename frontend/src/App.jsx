...
import CourierPackages from "./pages/courier_view/CourierPackages";
...
function Layout() {
  ...
  const isAuthArea =
    ...
    location.pathname.startsWith("/courier-packages") ||
  ...
  return (
    <>
      ...
      <Routes>
        ...
        {/* courier */}
        <Route path="/courier-packages" element={<CourierPackages />} />
